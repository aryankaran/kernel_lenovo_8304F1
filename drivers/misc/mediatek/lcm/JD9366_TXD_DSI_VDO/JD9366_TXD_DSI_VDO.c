...
{
	pr_err("LCM: lcm_get_gpio_infor is going\n");
...
static void lcm_init_lcm(void)
{
	...
	MDELAY(20);
#else
	pr_err("[Kernel/LCM] TXD lcm_init() enter\n");
	lcm_vgp_supply_enable();
...
LCM_DRIVER jd9366_txd_dsi_vdo_lcm_drv = 
{
	.name = "JD9366_TXD_DSI_VDO",
