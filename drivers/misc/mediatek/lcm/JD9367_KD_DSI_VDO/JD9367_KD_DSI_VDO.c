...
extern struct regulator *lcm_vgp3;
#ifdef BUILD_LK
...
//Set VCOM
{0x00,1,{0x00}},   //000-0ff 8bit reg
//{0x00,1,{0x01}}, //100-fff 9bit reg
{0x01,1,{0x7a}},   //0x3c=-0.315v (is default value)
//Set VCOM_Reverse
{0x03,1,{0x00}},
{0x04,1,{0x6F}},
...
static void lcm_init_lcm(void)
{
	...
	MDELAY(20);
#else
	pr_err("[Kernel/LCM] KD lcm_init() enter\n");
	lcm_vgp_supply_enable();
...
static void lcm_resume(void)
{
	...
	MDELAY(20);
	push_table(lcm_initialization_setting, sizeof(lcm_initialization_setting) / sizeof(struct LCM_setting_table), 1);
	pr_err("xrd [Kernel/LCM] lcm_resume() end\n");
#endif
}
...
LCM_DRIVER jd9367_kd_dsi_vdo_lcm_drv = 
{
	.name = "JD9367_KD_DSI_VDO",
