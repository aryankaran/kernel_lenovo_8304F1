...
#ifdef CONFIG_MTK_LENS_DW9714AFBLX4P_SUPPORT
#define DW9714AFBLX4P_SetI2Cclient DW9714AFBLX4P_SetI2Cclient_Main
#define DW9714AFBLX4P_Ioctl DW9714AFBLX4P_Ioctl_Main
#define DW9714AFBLX4P_Release DW9714AFBLX4P_Release_Main
extern void DW9714AFBLX4P_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9714AFBLX4P_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714AFBLX4P_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_DW9714AFQUN3P_SUPPORT
#define DW9714AFQUN3P_SetI2Cclient DW9714AFQUN3P_SetI2Cclient_Main
#define DW9714AFQUN3P_Ioctl DW9714AFQUN3P_Ioctl_Main
#define DW9714AFQUN3P_Release DW9714AFQUN3P_Release_Main
extern void DW9714AFQUN3P_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9714AFQUN3P_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714AFQUN3P_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif

#ifdef CONFIG_MTK_LENS_DW9714AFQUN4P_SUPPORT
#define DW9714AFQUN4P_SetI2Cclient DW9714AFQUN4P_SetI2Cclient_Main
#define DW9714AFQUN4P_Ioctl DW9714AFQUN4P_Ioctl_Main
#define DW9714AFQUN4P_Release DW9714AFQUN4P_Release_Main
extern void DW9714AFQUN4P_SetI2Cclient(struct i2c_client *pstAF_I2Cclient, spinlock_t *pAF_SpinLock,
				  int *pAF_Opened);
extern long DW9714AFQUN4P_Ioctl(struct file *a_pstFile, unsigned int a_u4Command,
			   unsigned long a_u4Param);
extern int DW9714AFQUN4P_Release(struct inode *a_pstInode, struct file *a_pstFile);
#endif
