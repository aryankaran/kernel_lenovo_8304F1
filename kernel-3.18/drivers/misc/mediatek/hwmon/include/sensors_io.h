...
/*add by xurendong for sensor cali*/
#define GSENSOR_IOCTL_CALI_READ_SENSORDATA              _IOR(GSENSOR, 0x16, int)   
#define GSENSOR_IOCTL_CALI_READ_AFTER_SENSORDATA        _IOR(GSENSOR, 0x17, int)
#define GSENSOR_IOCTL_CALI_SET_CALI                     _IOW(GSENSOR, 0x18, struct SENSOR_DATA)
/*end add by xurendong*/
#ifdef CONFIG_COMPAT
