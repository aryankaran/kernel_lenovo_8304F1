...
//extern int get_subcam_id_gpio_status(void);
...
static imgsensor_info_struct imgsensor_info = {
    ...
    .pre = {
        ...
        .linelength = 1054,            //record different mode's linelength
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
    ...
    kal_uint8 retry = 2;
	/*int subcamid = 0;
	int gpio_subid_status = 0;*/
    LOG_INF("sp2509:get_imgsensor_id() ++++"); 
...
// modified for camid by HQ_maoqiming 2017-04-13
			/*gpio_subid_status = get_subcam_id_gpio_status( );
			LOG_INF("[++++sp2509_cxt_gpio-id++++]vendor = %s\n", (gpio_subid_status == 1)?"bolixin":"chengxt");
			if (gpio_subid_status == 1) 
			{
				subcamid=1;
				*sensor_id += 1; 
			} 
		
			LOG_INF("[++++sp2509_cxt_gpio-id++++]*sensor_id=%x,subcamid = %d,gpio_subid_status=%d\n",*sensor_id,subcamid,gpio_subid_status);*/
