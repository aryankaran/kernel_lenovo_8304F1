...
int mt_led_blink_pmic(enum mt65xx_led_pmic pmic_type, struct nled_setting *led)
{
	...
	case MT65XX_LED_PMIC_NLED_ISINK0:
		...
		/*
		        ...
		        upmu_set_rg_isink0_ck_pdn(0x0);
		        upmu_set_rg_isink0_ck_sel(0x0);
		        upmu_set_isink_ch0_mode(0x01);
		        upmu_set_isink_ch0_step(0x01);
		        upmu_set_isink_breath0_trf_sel(0xf);
		        upmu_set_isink_breath0_ton_sel(0x8);
		        upmu_set_isink_breath0_toff_sel(0x8);
		        upmu_set_isink_ch0_en(0x1);
		*/
		upmu_set_rg_drv_32k_ck_pdn(0x0);
		upmu_set_rg_isink0_ck_pdn(0x0);
		upmu_set_rg_isink0_ck_sel(0x0);
	...
	case MT65XX_LED_PMIC_NLED_ISINK1:
		...
		/*
		        upmu_set_rg_drv_32k_ck_pdn(0x0);
		        upmu_set_rg_isink1_ck_pdn(0x0);
		        upmu_set_rg_isink1_ck_sel(0x0);
		        upmu_set_isink_ch1_mode(0x01);
		        upmu_set_isink_ch1_step(0x01);
		        upmu_set_isink_breath1_trf_sel(0xf);
		        upmu_set_isink_breath1_ton_sel(0x8);
		        upmu_set_isink_breath1_toff_sel(0x8);
	...
	case MT65XX_LED_PMIC_NLED_ISINK2:   /* keypad LR  16mA */
		...
		/*
		        upmu_set_rg_drv_32k_ck_pdn(0x0);
		        upmu_set_rg_isink2_ck_pdn(0x0);
		        upmu_set_rg_isink2_ck_sel(0x0);
		        upmu_set_isink_ch2_mode(0x01);
		        upmu_set_isink_ch2_step(0x01);
		        upmu_set_isink_breath2_trf_sel(0xf);
		        upmu_set_isink_breath2_ton_sel(0x8);
		        upmu_set_isink_breath2_toff_sel(0x8);
		        upmu_set_isink_ch2_en(0x1);
		*/
		upmu_set_rg_drv_32k_ck_pdn(0x0);
		upmu_set_rg_isink2_ck_pdn(0x0);
		upmu_set_rg_isink2_ck_sel(0x0);
...
int mt_brightness_set_pmic(enum mt65xx_led_pmic pmic_type, u32 level, u32 div)
{
	...
	if (pmic_type == MT65XX_LED_PMIC_BUTTON) {
		...
		if (level) {
                        upmu_set_rg_drv_32k_ck_pdn(0x0);
			upmu_set_isink_ch0_en(0x1);
			LEDS_DEBUG("[LED]---- enable ISINK0 HERE !!!\n");
		} else {
		        upmu_set_rg_drv_32k_ck_pdn(0x1);
                        upmu_set_isink_ch0_en(0x0);
			LEDS_DEBUG("[LED]---- Disbale ISINK0 HERE !!!\n");
		}
		return 0;
		...
		if (level) {
			...
			LEDS_DEBUG("[LED]---- enable ISINK1 HERE !!!\n");
#endif
		} else {
#ifdef PMIC_MT6325
...
#else
			upmu_set_rg_drv_32k_ck_pdn(0x1);
			//upmu_set_rg_isink1_ck_pdn(0x1);
			//upmu_set_rg_isink1_ck_sel(0x1);
			upmu_set_isink_ch1_en(0x0);

			LEDS_DEBUG("[LED]---- Disbale ISINK1 HERE!!!\n");
#endif
		}
		return 0;
...
#ifdef PMIC_MT6325
			upmu_set_isink_ch0_en(0x00);
			upmu_set_isink_ch1_en(0x00);
#endif
		}
		return 0;
	}
