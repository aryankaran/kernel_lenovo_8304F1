	...
	int ddp_dsi_build_cmdq(DISP_MODULE_ENUM module, void *cmdq_trigger_handle, CMDQ_STATE state)
{
		...
		if (state == CMDQ_BEFORE_STREAM_SOF) {
			...
			for (i = 0; i < 3; i++) {
				...
				if(t0.Data0 ==0x0A)//add for JD9366/9367 ESDcheck
					t0.Data_ID =DSI_GERNERIC_READ_LONG_PACKET_ID;//add for JD9366/9367 ESDcheck
				...
				if (hSlot) {
					cmdqRecBackupRegisterToSlot(cmdq_trigger_handle, hSlot, i,
								    0x14012078);//modify for JD9366/9367 ESDcheck
		/* cmdqRecBackupRegisterToSlot(cmdq_trigger_handle, hSlot, i, dsi_i ? 0x1401c074 : 0x1401b074); */
			...
			for (i = 0; i < 3; i++) {
				...
				if (read_data0.byte0 ==
				    dsi_params->lcm_esd_check_table[i].para_list[0]) {//modify for JD9366/9367 ESDcheck
					/* clear rx data */
			...
			DSI_OUTREGBIT(cmdq_trigger_handle, struct DSI_INT_STATUS_REG,
				...
				DSI_REG[dsi_i]->DSI_INTSTA, FRAME_DONE_INT_EN, 0);
			DSI_OUTREGBIT(cmdq_trigger_handle, struct DSI_INT_ENABLE_REG,
